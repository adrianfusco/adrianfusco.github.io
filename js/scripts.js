document.addEventListener('DOMContentLoaded', () => {
  ...
  pinnedRepos.forEach(repo => {
      ...
      projectItem.classList.add('p-6', 'bg-gray-100', 'dark:bg-gray-800', 'shadow-md', 'rounded-lg', 'mb-6');
      projectItem.innerHTML = `
      <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-2">${repo.name}</h4>
      <a href="${repo.url}" class="text-blue-600 dark:text-blue-400 underline hover:text-blue-500 dark:hover:text-blue-300 mb-4 block" target="_blank">View on GitHub</a>
